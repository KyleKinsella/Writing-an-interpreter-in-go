...
func TestBooleanExpressions(t *testing.T) {
    tests := []compilerTestCase{
        ...
        // the writer in the book does not use a "<" instruction he just uses > ...
        // therefore I might change this to have my own "<" instruction
        {
            input: "1 < 2",
            expectedConstants: []interface{}{2, 1},
            expectedInstructions: []code.Instructions{
...
func TestCompilerScopes(t *testing.T) {
    ...
    gloablSymbolTable := compiler.symbolTable
    ...
    if compiler.symbolTable.Outer != gloablSymbolTable {
    ...
    if compiler.symbolTable != gloablSymbolTable {
...
func testInstructions(expected []code.Instructions, actual code.Instructions) error {
    ...
    if len(actual) != len(concatted) {
        return fmt.Errorf("wrong instructions lenght\nwant=%q\ngot = %q", concatted, actual)
    }
